...
Router #(
    ...
    .men_in_east(men_in_east),
    .men_in_west(men_in_west),
    .men_in_north(men_in_north),
    .men_in_south(men_in_south),
    ...
    .men_out_east(men_out_east),
    .men_out_west(men_out_west),
    .men_out_north(men_out_north),
    .men_out_south(men_out_south)
);
