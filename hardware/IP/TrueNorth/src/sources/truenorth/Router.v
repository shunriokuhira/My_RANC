...
module Router #(
    ...
    wire men_local_to_east, men_local_to_west, men_north_to_local, men_south_to_local;
    wire men_east_to_north, men_east_to_south, men_west_to_north, men_west_to_south;
    wire buffer_empty_local;
    ...
    FromLocal #(
        ...
        .buffer_empty(buffer_empty_local),//output to Merge2 of ForwardEast(West) 
        .buffer_full(local_buffers_full),//output to controller
        
        .local_east_men(men_local_to_east),//output to Merge2 of ForwardEast(West)
        .local_west_men(men_local_to_west)//output to Merge2 of ForwardEast(West)
    ...
    ForwardEastWest #(
        ...
        .men_routing(men_in_west),//外部西コアからの信号。merge2に入る
        .men_token_controller(men_local_to_east),//merge2に入る
        
        .empty_routing(empty_in_west),                  // Input  -- Lets merge know if the buffer in the west core is empty
        .empty_token_controller(buffer_empty_local),   // Input  -- Lets merge know if the buffer in the from local module is empty
        
        //外側コアがパケットくださいという信号をrenとして送りそれを受信
        ...
        .routing_men(men_out_east),//外部西コアのmerge2宛
        .north_men(men_east_to_north),// ForwardSouthのmerge3宛
        .south_men(men_east_to_south),// ForwardSouthのmerge3宛
        
        .buffer_empty(empty_out_east)
    );
    ...
    ForwardEastWest #(
        ...
        .men_routing(men_in_east),
        .men_token_controller(men_local_to_west),
        ...
        //from pathdecoder
        .routing_men(men_out_west),
        .north_men(men_west_to_north),
        .south_men(men_west_to_south),
        
        .buffer_empty(empty_out_west)
    );
    ...
    ForwardNorthSouth #(
        ...
        .men_routing(men_in_south),
        .men_east(men_east_to_north),
        .men_west(men_west_to_north),

        .empty_routing(empty_in_south),                 // Input  -- Lets merge know if the buffer in the south core is empty
        .empty_east(empty_out_east),               // Input  -- Lets merge know if the buffer in the forward east module of this core is empty
        .empty_west(empty_out_west),               // Input  -- Lets merge know if the buffer in the forward west module of this core is empty
        ...
        .routing_men(men_out_north),
        .local_men(men_north_to_local),
        
        .buffer_empty(empty_out_north)
    ...
    ForwardNorthSouth #(
        ...
        .men_routing(men_in_north),
        .men_east(men_east_to_south),
        .men_west(men_west_to_south),
        ...
        .routing_men(men_out_south),
        .local_men(men_south_to_local),
        
        .buffer_empty(empty_out_south)
    ...
    LocalIn #(
        ...
        .men_north(men_north_to_local),
        .men_south(men_south_to_local),
        
        .empty_north(empty_out_north),             // Input  -- Lets merge know if the buffer in the forward north module of this core is empty
        .empty_south(empty_out_south),             // Input  -- Lets merge know if the buffer in the forward south module of this core is empty
