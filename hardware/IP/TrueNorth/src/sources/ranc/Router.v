...
module Router #(
    ...
    ForwardEastWest #(
        ...
        .routing_buffer_empty(empty_out_east),          // Output -- Lets the forward east module of the core to the east know if the buffer going to it is empty 東側コアのforward east moduleに向かうバッファが空かどうかを知らせる
