...
cmd = ('iverilog -o RANCNetwork.o -I ../../../sources/truenorth5 -Dgrid_dimension_x=%s '
       ...
       '../../../sources/truenorth5/*.v ../../tests_mnist/test_RANCNetwork.v')
...
def RANCNetwork(input_ports, output_ports, params):#test_RANCNetwork.pyで引数のinput_ports, output_ports, paramsは生成される
